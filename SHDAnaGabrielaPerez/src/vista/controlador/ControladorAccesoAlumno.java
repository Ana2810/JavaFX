...
alumnomodificado=null;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		materno.setPrefWidth(75.0);
		paterno.setPrefWidth(75.0);
		fecha.setPrefWidth(75.0);
		sexo.setPrefWidth(75.0);
		carrera.setPrefWidth(75.0);
		...
		txtApaterno.addEventFilter(KeyEvent.KEY_TYPED,new validarLetras());
		txtnombre.addEventFilter(KeyEvent.KEY_TYPED,new validarLetras());
		txtmaterno.addEventFilter(KeyEvent.KEY_TYPED,new validarLetras());
